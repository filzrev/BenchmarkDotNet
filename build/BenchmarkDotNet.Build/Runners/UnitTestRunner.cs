...
public class UnitTestRunner(BuildContext context)
{
    ...
    private DotNetTestSettings GetTestSettingsParameters(FilePath trxFile, string tfm)
    {
        var settings = new DotNetTestSettings
        {
            ...
            [
                "trx",
                $"trx;LogFileName={trxFile.FullPath}",
                $"html;LogFileName={trxFile.ChangeExtension(".html")}",
