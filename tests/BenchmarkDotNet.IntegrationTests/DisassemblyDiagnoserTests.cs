...
namespace BenchmarkDotNet.IntegrationTests
{
    public class DisassemblyDiagnoserTests : BenchmarkTestExecutor
    {
        ...
        public static IEnumerable<object[]> GetAllJits()
        {
            ...
            yield return [JitInfo.GetCurrentJit(), RuntimeInformation.GetCurrentPlatform(), CsProjClassicNetToolchain.Net472]; // InProcess
        ...
        public void Test123()
        {
            ...
            var path = new DirectoryInfo(dir).GetFiles("capstone*", SearchOption.AllDirectories)
